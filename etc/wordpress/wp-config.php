 ...
 * @since 2.6.0
 */
define('AUTH_KEY',              $wpSecrets['AUTH_KEY']);
define('SECURE_AUTH_KEY',       $wpSecrets['SECURE_AUTH_KEY']);
define('LOGGED_IN_KEY',         $wpSecrets['LOGGED_IN_KEY']);
define('NONCE_KEY',             $wpSecrets['NONCE_KEY']);
define('AUTH_SALT',             $wpSecrets['AUTH_SALT']);
define('SECURE_AUTH_SALT',      $wpSecrets['SECURE_AUTH_SALT']);
define('LOGGED_IN_SALT',        $wpSecrets['LOGGED_IN_SALT']);
define('NONCE_SALT',            $wpSecrets['NONCE_SALT']);
